...
namespace SharpMap.Data.Providers.Business.Tests.Memory
{
    ...
    public class PointsOfInterest : List<PointOfInterest>
    {
        public static PointsOfInterest Create()
        {
            ...
            res.Add(new PointOfInterest { ID = 2, Address = "cl", Kind = "African food", Geometry = f.CreatePoint(new Coordinate(0, 1)) });
            res.Add(new PointOfInterest { ID = 3, Address = "rl", Kind = "African food", Geometry = f.CreatePoint(new Coordinate(0, 2)) });
            res.Add(new PointOfInterest { ID = 4, Address = "lc", Kind = "African food", Geometry = f.CreatePoint(new Coordinate(1, 0)) });
            res.Add(new PointOfInterest { ID = 5, Address = "cc", Kind = "African food", Geometry = f.CreatePoint(new Coordinate(1, 1)) });
            res.Add(new PointOfInterest { ID = 6, Address = "cr", Kind = "African food", Geometry = f.CreatePoint(new Coordinate(1, 2)) });
            res.Add(new PointOfInterest { ID = 7, Address = "tl", Kind = "African food", Geometry = f.CreatePoint(new Coordinate(2, 0)) });
            res.Add(new PointOfInterest { ID = 8, Address = "tc", Kind = "African food", Geometry = f.CreatePoint(new Coordinate(2, 1)) });
